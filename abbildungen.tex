...
\texttt{subcaption}-Pakets \cite{Cochran95} in Betracht ziehen. Ein Beispiel ist in der Vorlage in Abbildung \ref{fig:Settings} zu finden.
...
\verb!\cite{..}! die Kombination \verb!\footnotemark! und \verb!\citetext! verwendet werden. Weitere Details zu dieser Art von Quellenangaben finden sich in Kap.\ \ref{cha:Literatur}.
...
Aus \citetitle{Faires34}.\cite{Faires34} }
\label{fig:Bearings}
\end{figure}
