...
\citetitle{Kopka98}\cite[Kap.\ 5]{Kopka98} oder \citetitle{mathmode09}\cite{mathmode09}.
...
\end{center}
%
Für Interessierte findet sich mehr zum Thema Mathematik und Prosa in \citetitle{Mermin89}\cite{Mermin89} und \citetitle{Higham98}\cite{Higham98}.
...
Zahlreiche weitere mathematische Konstrukte des \texttt{amsmath}-Pakets sind in \citetitle{amsldoc02}\cite{amsldoc02} beschrieben.
...
Umfangreichere Beispiele für Algorithmen mit diesem Setup findet man \ua\ in \citetitle{BurgerBurge06}\cite{BurgerBurge06}.
